...
class Robot:
    ...
    def _robot_translate(self):
        ...
        robotic_finder = re.compile(r"(RESTART|SHOW|OVER|{}|{}|{}|{})\s?(\d*)\s?(SHOW|OVER)?"
    ...
    def _robot_process(self):
        ...
        elif self.robot_place["UP"] - self.robot_place["DOWN"] <= -self.place[0]:
